    ...
    public function store(Request $request): JsonResponse
    {
        try {
            $validated = $request->validate([
                ...
                'settings.actions.onEnter.*.type' => ['required','string', Rule::in(['set_situacao', 'move_to_funnel', 'transfer_funnel'])],
                'settings.actions.onEnter.*.situacao_id' => 'nullable|integer',
                'settings.actions.onEnter.*.target_funnel_id' => 'nullable',
                'settings.actions.onEnter.*.target_stage_id' => 'nullable',
                ...
                'settings.actions.onExit.*.type' => ['required','string', Rule::in(['set_situacao', 'move_to_funnel', 'transfer_funnel'])],
                'settings.actions.onExit.*.situacao_id' => 'nullable|integer',
                'settings.actions.onExit.*.target_funnel_id' => 'nullable',
                'settings.actions.onExit.*.target_stage_id' => 'nullable',
