...
export default function SystemSettings() {
  ...
  /**
   * Converte cor hex para valores HSL (utilizado para variáveis do shadcn)
   */
  ...
  const applyAppearanceSettings = (settings: typeof appearanceSettings) => {
    ...
    if (settings.primaryTextColor) {
      const hsl = hexToHsl(settings.primaryTextColor);
    ...
    if (settings.secondaryTextColor) {
      const hsl = hexToHsl(settings.secondaryTextColor);
